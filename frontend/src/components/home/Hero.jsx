...
export const Hero = () => {
    return (
        <div className='py-15 bg-slate-grey/10 flex gap-15 justify-center px-8 items-center'>
            <div className="max-w-lg w-full">
                <h1 className='text-6xl w-100 font-bold'>Scale Your Kitchen <span className='text-punch-red'>With Confidence.</span></h1>
            ...
            <div className="max-w-lg aspect-square mt-5 shadow-[0_10px_20px] shadow-slate-grey border-4 rounded-4xl overflow-hidden">
