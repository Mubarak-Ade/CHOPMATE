...
export const Plan = () => {
  return (
    <div className='w-full p-5'>
      ...
      <p  className='text-gray mb-6 text-slate-grey/80'>select the best subscription plan to growth your bussiness</p>
      ...
      <div className='flex gap-5'>
        <div className='border-2 rounded-xl p-5 w-full space-y-2 hover:border-punch-red'>
          ...
          <button className='bg-punch-red px-6 py-1 text-white rounded-xl font-bold mb-5 '>Select Plan</button>
          <h3>FEATURES</h3>
          <div className='flex gap-2 items-center'>
            <Icon icon={Check} size={14} className={'bg-emerald text-white rounded-full'}/>
        ...
        <div className='border-2 rounded-xl p-5 w-full space-y-2 hover:border-punch-red'>
          ...
          <h1 className='text-2xl font-bold mb-4'>$49<span className='text-xl text-slate-grey/50'>/month</span></h1>
          <button className='bg-punch-red px-6 py-1 text-white rounded-xl font-bold mb-5 '>Select Plan</button>
         ...
         <div className='border-2 rounded-xl p-5 w-full space-y-2 hover:border-punch-red'>
          ...
          <h1 className='text-2xl font-bold mb-4'>$129<span className='text-xl text-slate-grey/50'>/month</span></h1>
          <button className='bg-punch-red px-6 py-1 text-white rounded-xl font-bold mb-5 '>Select Plan</button>
       ...
       <div className='flex mt-5 mb-6 justify-between'>
          ...
          <button className='bg-punch-red px-6 py-3 text-white rounded-xl font-bold shadow-[0_2px_10px] shadow-punch-red/50 flex gap-2' >Continue to Next Step <span>< Icon icon={ArrowRight}/></span></button>
         </div>
         </div>
  )
}
